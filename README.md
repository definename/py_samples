...
> Списки представляют собой упорядоченные по позициям коллекции объектов произвольних типов
...
> `dict` представляет собой структуру данных вида: `ключ`: `значение`, элелменты в словарях
...
:point_up: `Функции` - это именованый фрагмент кода, отделенный от других.
