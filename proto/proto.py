...
def main():
    outf = frame.FrameHeader(0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006,
                             0x0007, 0x0008, 0x0009, 0x0010, 0x0011, 0x0012)

    logger.debug(
        "Origin frame header: {}".format(outf))

    header = struct.Struct(">12H")

    out_data = header.pack(
        outf.cmd,
        outf.sub_cmd,
        outf.error_hash,
        outf.src_addr,
